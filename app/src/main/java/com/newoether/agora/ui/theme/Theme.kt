...
/** The resolved dark/light state [AgoraTheme] computed from [ThemeMode] (+ system setting, for
 *  [ThemeMode.FOLLOW_DEVICE]) — read this instead of guessing from [MaterialTheme.colorScheme]
