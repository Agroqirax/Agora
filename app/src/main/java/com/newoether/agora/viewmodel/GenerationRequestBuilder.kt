...
class GenerationRequestBuilder(
    ...
    internal fun buildGenerationPair(
        ...
        val genCtx = GenerationContext(
            ...
            appLaunchEnabled = settings.appLaunchEnabled.value,
            urlOpenEnabled = settings.urlOpenEnabled.value,
            ...
            weatherGeocodingBaseUrl = settings.weatherGeocodingBaseUrl.value.ifBlank { com.newoether.agora.tool.WeatherToolProvider.DEFAULT_GEOCODING_BASE_URL },
