...
class GenerationRequestBuilder(
    ...
    private fun buildGenerationPair(
        ...
        val genCtx = GenerationContext(
            ...
            htmlChatWidgetsEnabled = settings.htmlChatWidgetsEnabled.value,
            mermaidChatWidgetsEnabled = settings.mermaidChatWidgetsEnabled.value,
            geoJsonChatWidgetsEnabled = settings.geoJsonChatWidgetsEnabled.value,
